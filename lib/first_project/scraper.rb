class FirstProject::Scraper
  ...
  def self.today
    ...
    env_1.url = "https://www.upwork.com/freelance-jobs/"

    env_2 = self.new
    env_2.name = "Business Administration"
    env_2.availability = true
    env_2.url = "https://www.upwork.com/freelance-jobs/"

    env_3 = self.new
    env_3.name = "Computer Science"
    env_3.availability = true
    env_3.url = "https://www.upwork.com/freelance-jobs/"

    env_4 = self.new
    env_4.name = "Health Science"
    env_4.availability = true
    env_4.url = "https://www.upwork.com/freelance-jobs/"
